      ...
      contents: [
        {
          parts: [
            {
              text: `Analyze the image independently to determine the location using landmarks, buildings, or geography. Do not directly merge the user's suggested location ("${userLocation}") into the final location result.
